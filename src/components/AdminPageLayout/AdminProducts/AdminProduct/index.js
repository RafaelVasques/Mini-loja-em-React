            ...
            <figure>
                ...
                <div className="admin__product-controls">
                    <div className="admin__product-controls-wrapper">
                        <a href="#top" className="admin__product-control-delete"><img src="/images/trash.svg" alt="Excluir Produto" /></a>
                        <a href="/admin/add-product" className="admin__product-control-edit"><img src="/images/edit.svg" alt="Editar Produto" /></a>
                    </div>
                </div>
