export function AllProducts() {
  ...
  const listProducts = [{
        ...
        products: [{
            ...
            productImgUrl: '/images/products_imgs/unsplash_R8L1l9RN198.png',
            productName: 'Boneco Mini Yoda',
            productPrice: '60,00',
            productDescription: 'descrição do produto',
            productCode: '#111111'
      },{
            productImgUrl: '/images/products_imgs/unsplash_1VV1MRafd7A.png',
            productName: 'Boneco Kylo Ren',
            productPrice: '85,50',
            productDescription: 'descrição do produto',
            productCode: '#111111'
      }]
        ...
        products: [{
            ...
            productImgUrl: '/images/products_imgs/unsplash_r27umXAelDc.png',
            productName: 'Pikachu Pelucia',
            productPrice: '85,00',
            productDescription: 'descrição do produto',
            productCode: '#111111'
      }]
